...
block.history <- getBlockData("20151202", bID, mbta)
@ 
...
It appears that the MBTA ``block_id'' is messed up; it's not giving a non-overlapping set of trips

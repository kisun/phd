...
\begin{verbatim}
##    trip_id shape_id  n
## 1 28244696   220103 20
## 2 28244702   220103 20
## 3 28244725   450048 20
## 4 28244759   440064 20
## 5 28244794   650025 20
## 6 28244806   550024 20
\end{verbatim}
\end{kframe}
\end{knitrout}

So, trip \verb+28244696+ looks pretty popular. We'll get some useful information for that.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\begin{verbatim}
##        lat       lon       time
## 1 42.29300 -71.08129 1449014796
## 2 42.29300 -71.08129 1449014796
## 3 42.29300 -71.08129 1449014796
## 4 42.29472 -71.08710 1449014877
## 5 42.29472 -71.08710 1449014877
## 6 42.29482 -71.08747 1449014938
## 
##       date    trip_id 
## "20151201" "28244696"
\end{verbatim}
...
## 1  C22-161 28253208       15   150077
## 2  C22-161 28260076       15   150077
## 3  C22-161 28253206       15   150079
## 4  C22-161 28252591       15   150079
## 5  C22-161 27494985       15   150078
## 6  C22-161 28262423       15   150078
\end{verbatim}
\begin{alltt}
...
\hlstd{getBlockData} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{date}\hlstd{,} \hlkwc{id}\hlstd{,} \hlkwc{conn}\hlstd{) \{}
    ...
    \hlstd{d}
\hlstd{\}}
\hlstd{block.history} \hlkwb{<-} \hlkwd{getBlockData}\hlstd{(}\hlstr{"20150820"}\hlstd{, bID, mbta)}
\end{alltt}
\end{kframe}
\end{knitrout}

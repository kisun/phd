...
{\centering \includegraphics[width=\maxwidth]{figure/block_day_functions-1} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in y[1, ] * pi: non-numeric argument to binary operator}}\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=\maxwidth]{figure/plot_new_fit-1} 

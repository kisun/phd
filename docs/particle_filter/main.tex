...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{blockPF} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{block}\hlstd{,} \hlkwc{...}\hlstd{) \{}
    \hlstd{pf} \hlkwb{<-} \hlkwd{particleFilter}\hlstd{(block}\hlopt{$}\hlstd{history, block}\hlopt{$}\hlstd{path, ...)}
...
\hlstd{plot.pf.blockfit} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{,} \hlkwc{obs} \hlstd{=} \hlnum{1}\hlstd{,} \hlkwc{highlight} \hlstd{=} \hlnum{FALSE}\hlstd{) \{}
    ...
    \hlkwd{points}\hlstd{(x}\hlopt{$}\hlstd{y[}\hlnum{1}\hlstd{,obs], x}\hlopt{$}\hlstd{y[}\hlnum{2}\hlstd{,obs],} \hlkwc{col} \hlstd{=} \hlstr{"red"}\hlstd{,} \hlkwc{pch} \hlstd{=} \hlnum{19}\hlstd{,} \hlkwc{cex} \hlstd{=} \hlnum{0.4}\hlstd{)}
\hlstd{\}}
\hlcom{#pfit <- blockPF(block, x0 = rbind(}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{plot}\hlstd{(pfit,} \hlkwc{obs} \hlstd{=} \hlnum{8}\hlstd{,} \hlkwc{highlight} \hlstd{=} \hlnum{1}\hlstd{)}
\end{alltt}
\end{kframe}

...
\end{verbatim}
\begin{alltt}
\hlstd{trip881} \hlkwb{<-} \hlstd{athist[athist}\hlopt{$}\hlstd{trip_id} \hlopt{==} \hlstr{"12881005589-20151224100745_v36.10"}\hlstd{, ]}
\hlstd{obj} \hlkwb{<-} \hlkwd{iNZightMap}\hlstd{(}\hlkwc{lat}\hlstd{=}\hlopt{~}\hlstd{position_latitude,} \hlkwc{lon}\hlstd{=}\hlopt{~}\hlstd{position_longitude,} \hlkwc{data} \hlstd{= trip881,}
                  \hlkwc{name} \hlstd{=} \hlstr{"Route 881 Journey"}\hlstd{)}
\hlkwd{plot}\hlstd{(obj,} \hlkwc{pch} \hlstd{=} \hlnum{4}\hlstd{,} \hlkwc{cex.pt} \hlstd{=} \hlnum{0.5}\hlstd{,} \hlkwc{map.opacity} \hlstd{=} \hlnum{0.4}\hlstd{)}
\end{alltt}
\end{kframe}

...
\hlstd{accelPF} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{block}\hlstd{,}
    ...
    \hlcom{## Matrix prep:}
    \hlstd{hx} \hlkwb{<-} \hlstd{hxhat} \hlkwb{<-} \hlstd{xxhat} \hlkwb{<-} \hlstd{xx} \hlkwb{<-} \hlkwd{array}\hlstd{(}\hlnum{NA}\hlstd{,} \hlkwd{c}\hlstd{(}\hlnum{3}\hlstd{, N, M} \hlopt{+} \hlnum{1}\hlstd{))}
    ...
    \hlstd{\}}
    \hlkwa{for} \hlstd{(i} \hlkwa{in} \hlnum{1}\hlopt{:}\hlstd{M) \{}
        \hlstd{xxhat[,,i}\hlopt{+}\hlnum{1}\hlstd{]} \hlkwb{<-} \hlkwd{fn}\hlstd{(xx[,,i],} \hlkwd{c}\hlstd{(Delta[i], TIME[i}\hlopt{+}\hlnum{1}\hlstd{]),} \hlkwd{pw}\hlstd{(N))}
        \hlstd{weights} \hlkwb{<-} \hlkwd{apply}\hlstd{(xxhat[,,i}\hlopt{+}\hlnum{1}\hlstd{],} \hlnum{2}\hlstd{,} \hlkwa{function}\hlstd{(}\hlkwc{xi}\hlstd{)} \hlkwd{lhood}\hlstd{(y[,i}\hlopt{+}\hlnum{1}\hlstd{], xi))}
        \hlstd{qi} \hlkwb{<-} \hlstd{weights} \hlopt{/} \hlkwd{sum}\hlstd{(weights)}
        \hlkwa{if} \hlstd{(}\hlkwd{any}\hlstd{(}\hlkwd{is.na}\hlstd{(qi)))}
            \hlstd{qi} \hlkwb{<-} \hlkwa{NULL}
...
\hlcom{## The formal model ...}
\hlcom{## ---------------------------------------------------------------- ##}
\hlstd{fn} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{,} \hlkwc{u}\hlstd{,} \hlkwc{w}\hlstd{) \{} \hlcom{## x: [distance, velocity]; u: [delta, time]; w: [error]}
    ...
    \hlstd{W} \hlkwb{<-} \hlkwd{rbind}\hlstd{(}\hlnum{0.5} \hlopt{*} \hlstd{w} \hlopt{*} \hlstd{u[}\hlnum{1}\hlstd{]}\hlopt{^}\hlnum{2}\hlstd{,}
               \hlstd{w} \hlopt{*} \hlstd{u[}\hlnum{2}\hlstd{],}
               \hlstd{w)}

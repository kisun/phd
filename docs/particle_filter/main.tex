...
\begin{equation}
  ...
  \end{bmatrix}.
\end{equation}
Of course, we don't know $d_k$ yet, so we will need to compute $a_k$ as required.
...
\begin{align*}
  ...
  &=
    \begin{bmatrix}
      \hat d_{k+1} \\ \hat v_{k+1} \\ \hat a_{k+1}
    \end{bmatrix}
  =
  \begin{bmatrix}
    d_k + v_k \delta_k + \frac{1}{2} a_k \delta_k^2 \\
    v_k + a_k \delta_k \\
    s'\left(d_{k+1}\right)
  \end{bmatrix} \\
  \bx_{k+1} &= \hat \bx_{k+1} + W_k \\
  &=
    \begin{bmatrix}
      \hat d_{k+1} \\ \hat v_{k+1} \\ \hat a_{k+1}
    \end{bmatrix} +
  \begin{bmatrix}
    \frac{1}{2} \varepsilon_k \delta_k^2 \\
    \varepsilon_k \delta_k \\
    \varepsilon_k
  \end{bmatrix},\quad
  \varepsilon_k \sim \mathcal{N}\left(0, \sigma_a\right)
\end{align*}

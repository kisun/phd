...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in `[.data.frame`(shape, , 1:2): undefined columns selected}}\end{kframe}
\end{knitrout}
...
\hlstd{getBlock} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{ids}\hlstd{,} \hlkwc{date}\hlstd{,} \hlkwc{conn}\hlstd{) \{}
    ...
    \hlstd{speedFns} \hlkwb{<-} \hlkwd{tapply}\hlstd{(}\hlnum{1}\hlopt{:}\hlkwd{nrow}\hlstd{(schedule), schedule}\hlopt{$}\hlstd{trip_id,}
                       \hlkwa{function}\hlstd{(}\hlkwc{id}\hlstd{) \{}
                           \hlstd{x} \hlkwb{<-} \hlstd{schedule}\hlopt{$}\hlstd{shape_dist_traveled[id]}
                           ...
                           \hlstd{yy} \hlkwb{<-} \hlkwd{unique}\hlstd{(t0)}
                           \hlstd{xx} \hlkwb{<-} \hlkwd{tapply}\hlstd{(x, t0, min)}

                           \hlkwd{splinefun}\hlstd{(xx, yy)}
                       \hlstd{\})}
...
\hlkwd{curve}\hlstd{(}\hlkwd{fn1}\hlstd{(x),} \hlnum{0}\hlstd{,}
      ...
      \hlkwc{xlab} \hlstd{=} \hlstr{"Distance (m)"}\hlstd{,} \hlkwc{ylab} \hlstd{=} \hlstr{"Time (s)"}\hlstd{)}
\end{alltt}
\end{kframe}
...
\begin{kframe}\begin{alltt}
\hlkwd{curve}\hlstd{(}\hlkwd{fn1}\hlstd{(x,} \hlnum{1}\hlstd{),} \hlnum{0}\hlstd{,}
      \hlkwd{max}\hlstd{(block.speed}\hlopt{$}\hlstd{schedule[block.speed}\hlopt{$}\hlstd{schedule}\hlopt{$}\hlstd{trip_id} \hlopt{==}
                                   \hlstd{block.speed}\hlopt{$}\hlstd{trips}\hlopt{$}\hlstd{trip_id[}\hlnum{1}\hlstd{], ]}\hlopt{$}\hlstd{shape_dist_traveled),}
      \hlkwc{xlab} \hlstd{=} \hlstr{"Distance (m)"}\hlstd{,} \hlkwc{ylab} \hlstd{=} \hlstr{"Speed (m/s)"}\hlstd{)}
\end{alltt}
...
\begin{equation}
  ...
  \bx_k = A_k \bx_{k-1} + B_k \bu_k + G_k \bw_k
\end{equation}

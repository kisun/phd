...
{\centering \includegraphics[width=0.5\textwidth]{figure/stop_times} 
...
{\centering \includegraphics[width=0.5\textwidth]{figure/stop_times_curve} 
...
{\centering \includegraphics[width=0.5\textwidth]{figure/data_set} 
...
\hlstd{EKF} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{d}\hlstd{) \{}
    ...
    \hlstd{P.} \hlkwb{<-} \hlstd{Fk} \hlopt{%*%} \hlstd{d}\hlopt{$}\hlstd{Phat} \hlopt{%*%} \hlkwd{t}\hlstd{(Fk)} \hlopt{+} \hlstd{Q}
...
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/kalman_filter} 
...
{\centering \includegraphics[width=0.8\textwidth]{figure/unnamed-chunk-2} 
...
\hlkwd{plotMe}\hlstd{()}
\hlkwd{lines}\hlstd{(t[}\hlnum{1}\hlopt{:}\hlstd{k], X[}\hlnum{1}\hlstd{,} \hlnum{1}\hlopt{:}\hlstd{k],} \hlkwc{col} \hlstd{=} \hlstr{"blue"}\hlstd{,} \hlkwc{cex} \hlstd{=} \hlnum{0.5}\hlstd{,} \hlkwc{pch} \hlstd{=} \hlnum{19}\hlstd{)}
\hlstd{xhat.} \hlkwb{<-} \hlstd{X.[}\hlnum{1}\hlstd{,} \hlnum{1}\hlopt{:}\hlstd{k]}
\hlstd{xhatSD.} \hlkwb{<-} \hlkwd{sqrt}\hlstd{(P[}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{1}\hlopt{:}\hlstd{k])}
\hlstd{ci.l} \hlkwb{<-} \hlkwd{qnorm}\hlstd{(}\hlnum{0.025}\hlstd{, xhat., xhatSD.)}
\hlstd{ci.u} \hlkwb{<-} \hlkwd{qnorm}\hlstd{(}\hlnum{0.975}\hlstd{, xhat., xhatSD.)}
\hlkwd{arrows}\hlstd{(t[}\hlnum{1}\hlopt{:}\hlstd{k], ci.l, t[}\hlnum{1}\hlopt{:}\hlstd{k], ci.u,} \hlkwc{length} \hlstd{=} \hlnum{0.05}\hlstd{,} \hlkwc{angle} \hlstd{=} \hlnum{90}\hlstd{,} \hlkwc{code} \hlstd{=} \hlnum{3}\hlstd{,} \hlkwc{col} \hlstd{=} \hlstr{"#00880060"}\hlstd{)}
\hlkwd{points}\hlstd{(t[}\hlnum{1}\hlopt{:}\hlstd{k], xhat.,} \hlkwc{pch} \hlstd{=} \hlnum{21}\hlstd{,} \hlkwc{bg} \hlstd{=} \hlstr{"white"}\hlstd{,} \hlkwc{col} \hlstd{=} \hlstr{"#00880060"}\hlstd{)}
\hlkwd{points}\hlstd{(t[}\hlnum{1}\hlopt{:}\hlstd{k], x[}\hlnum{1}\hlopt{:}\hlstd{k],} \hlkwc{cex} \hlstd{=} \hlnum{0.4}\hlstd{,} \hlkwc{pch} \hlstd{=} \hlnum{19}\hlstd{)}

\hlcom{## now, progress forward:}
\hlkwa{for} \hlstd{(k} \hlkwa{in} \hlnum{6}\hlopt{:}\hlkwd{length}\hlstd{(x)) \{}
    \hlstd{d} \hlkwb{<-} \hlkwd{list}\hlstd{(}\hlkwc{xhat} \hlstd{= X[, k}\hlopt{-}\hlnum{1}\hlstd{],} \hlkwc{Phat} \hlstd{= P[,,k}\hlopt{-}\hlnum{1}\hlstd{],} \hlkwc{u} \hlstd{=} \hlkwd{c}\hlstd{(t[k}\hlopt{-}\hlnum{1}\hlstd{],} \hlkwd{diff}\hlstd{(t)[k}\hlopt{-}\hlnum{1}\hlstd{]))}
    \hlstd{KF} \hlkwb{<-} \hlkwd{EKF}\hlstd{(d)}
    \hlstd{X.[, k]} \hlkwb{<-} \hlstd{KF}\hlopt{$}\hlstd{x.}
    \hlstd{P.[,,k]} \hlkwb{<-} \hlstd{KF}\hlopt{$}\hlstd{P.}
    \hlstd{X[, k]} \hlkwb{<-} \hlstd{KF}\hlopt{$}\hlstd{xn}
...
\hlstd{xhat.} \hlkwb{<-} \hlstd{X.[}\hlnum{1}\hlstd{,} \hlnum{6}\hlopt{:}\hlstd{k]}
\hlstd{xhatSD.} \hlkwb{<-} \hlkwd{sqrt}\hlstd{(P[}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{,}\hlnum{6}\hlopt{:}\hlstd{k])}
\hlstd{ci.l} \hlkwb{<-} \hlkwd{qnorm}\hlstd{(}\hlnum{0.025}\hlstd{, xhat., xhatSD.)}
\hlstd{ci.u} \hlkwb{<-} \hlkwd{qnorm}\hlstd{(}\hlnum{0.975}\hlstd{, xhat., xhatSD.)}
\hlkwd{arrows}\hlstd{(t[}\hlnum{6}\hlopt{:}\hlstd{k], ci.l, t[}\hlnum{6}\hlopt{:}\hlstd{k], ci.u,} \hlkwc{length} \hlstd{=} \hlnum{0.05}\hlstd{,} \hlkwc{angle} \hlstd{=} \hlnum{90}\hlstd{,} \hlkwc{code} \hlstd{=} \hlnum{3}\hlstd{,} \hlkwc{col} \hlstd{=} \hlstr{"#00880060"}\hlstd{)}
\hlkwd{points}\hlstd{(t[}\hlnum{6}\hlopt{:}\hlstd{k], xhat.,} \hlkwc{pch} \hlstd{=} \hlnum{21}\hlstd{,} \hlkwc{bg} \hlstd{=} \hlstr{"white"}\hlstd{,} \hlkwc{col} \hlstd{=} \hlstr{"#00880060"}\hlstd{)}

\hlkwd{points}\hlstd{(t[}\hlnum{6}\hlopt{:}\hlstd{k], x[}\hlnum{6}\hlopt{:}\hlstd{k],} \hlkwc{cex} \hlstd{=} \hlnum{0.4}\hlstd{,} \hlkwc{pch} \hlstd{=} \hlnum{19}\hlstd{,} \hlkwc{col} \hlstd{=} \hlstr{"#33333340"}\hlstd{)}
\end{alltt}
\end{kframe}

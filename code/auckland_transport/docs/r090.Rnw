...
<<compare_historical_speeds,fig.width=9,fig.height=5>>=
...
<<speed_diff_5000m,fig.width=9,fig.height=5>>=
...
<<eval=FALSE>>=p
b <- txtProgressBar(3, nrow(test.trip), initial = 3, style = 3)

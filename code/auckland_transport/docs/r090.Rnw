...
<<future_observations,fig.width=9,fig.height=12,cache=TRUE>>=
#par(mfcol = c(6, 2), mar = c(0, 0, 0, 1), oma = c(5.1, 4.1, 4.1, 2.1))p
...
<<remaining_obs,fig.width=9,fig.height=12,cache=TRUE>>=
#par(mfcol = c(6, 2), mar = c(0, 0, 0, 1), oma = c(5.1, 4.1, 4.1, 2.1))
#for(i in 28:nrow(test.trip)) {

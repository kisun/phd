...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in max(dx/dt): no non-missing arguments to max; returning -Inf}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in max(dx/dt): no non-missing arguments to max; returning -Inf}}\begin{alltt}
...
\end{alltt}
\end{kframe}% latex table generated in R 3.2.2 by xtable 1.8-2 package
% Tue Mar  8 16:13:40 2016
\begin{table}[p]
\centering
...
## 2016-01-23 2016-01-25 2016-01-26 2016-01-29 2016-02-09 2016-02-18 
##  11.238868  10.760644   0.000000  12.060710  10.794153   8.124656 
## 2016-02-19 
##  11.562566
\end{verbatim}
\end{kframe}
...
\end{alltt}
\begin{verbatim}
## SELECT DISTINCT t.trip_id, st.departure_time, t.route_id, t.shape_id,
##        s.shape_pt_lat, s.shape_pt_lon, s.shape_pt_sequence
## FROM trips AS t, stop_times AS st, shapes AS s
## WHERE t.trip_id IN ('3090020609-20160126172118_v37.18') AND t.trip_id = st.trip_id AND st.stop_sequence = 1 AND t.shape_id = s.shape_id
...
\end{alltt}
\begin{verbatim}
## SELECT st.trip_id, st.arrival_time, st.departure_time, st.stop_id, s.stop_lon, s.stop_lat, st.stop_sequence
## FROM stop_times AS st, stops AS s
## WHERE st.stop_id = s.stop_id AND st.trip_id = '3090020609-20160126172118_v37.18'
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in sqrt(r2): NaNs produced}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in sqrt(r2): NaNs produced}}\begin{alltt}
...
\hlstd{plotTravelTimes} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{origin}\hlstd{,} \hlkwc{destination}\hlstd{,} \hlkwc{history}\hlstd{) \{}
    ...
    \hlstd{iNZightPlots}\hlopt{::}\hlkwd{iNZightPlot}\hlstd{(}\hlkwc{y} \hlstd{= travel_time,} \hlkwc{x} \hlstd{= start_hour,} \hlkwc{boxplot} \hlstd{=} \hlnum{FALSE}\hlstd{,}
                              ...
                              \hlkwc{colby} \hlstd{= date,} \hlkwc{pch} \hlstd{=} \hlnum{19}\hlstd{,} \hlkwc{cex.pt} \hlstd{=} \hlnum{0.1}\hlstd{,} \hlkwc{col.fun} \hlstd{= rainbow_hcl,}

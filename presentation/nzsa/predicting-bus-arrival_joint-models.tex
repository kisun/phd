...
\begin{frame}[c]
  ...
  \centering
  \hspace{2em}$\bY_k$\hspace{13em}$\bX_k$
  
  \vspace{-3em}
  \includegraphics{figure/vehicle-state-1.pdf}
  \includegraphics{figure/vehicle-state-2.pdf}

  \scriptsize{Example: $d_k = 2000$}
\end{frame}
...
\begin{frame}
  ...
  \item \alert<2>{Vehicle state}
  \item \alert<2>{Road state}
  \end{enumerate}

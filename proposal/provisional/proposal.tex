...
The main goal:
- to predict a bus' time of arrival at future stops
- communicate this information to commuters in a useful manner

Why this is useful:
- reducing percieved wait times
- provide better information for journey planning

How it will be done:
- GTFS-realtime feed with vehicle locations, schedule information, etc
- Sequential state models to estimate vehicles' state: (Kalman Filter and) Particle Filter
- Modeling buses
- Predictive models for n-stops ahead arrival time


# SECTION 2.1: GTFS

- what GTFS is
- what GTFS(-realtime) gives us
- how we use it


# SECTION 2.2: Sequential State Models

- the idea behind them (one point at a time)
- Kalman Filter: where it's been used, why, very brief how
- Issues with KF ... 
- Particle Filter: few places it's been used, flexibility, how it works


# SECTION 2.3: Bus location modeling and prediction

- what's been done
- the general idea ...
- unique issues: dwell times
- what *hasn't* been done ...


# SECTION 2.4: Providing information to commuters

- all the apps out there ... 
- time till arrival
- journey planning

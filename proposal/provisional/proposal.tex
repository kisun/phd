...
In order to attact greater ridership, many agencies have deployed \glspl{atis}
...
\citep{cn}.
Several studies have shown that in the presense of real-time arrival information, 
passengers percieve shorter waiting times (time passes more quickly), 
...
including real-time vehicle locations, to deveopers, 
...
targetting a range of different applications.
...
%We will attempt to improve the overall accuracy of the predictions,
%and then investigate methods of communicating the remaining uncertainty to passengers,
%such as with predictions intervals.
...
(who we cannot assume to have any understanding of the concept of ``confidence'' or ``credible'' interval),
